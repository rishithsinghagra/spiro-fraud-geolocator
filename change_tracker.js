...
function renderTable() {
    ...
    const tableData = pings.map(p => {
        ...
        return {
            ...
            last_mapped_type: p.last_mapped.slice(0,7),
            brand: p.bms_id.slice(0,1),
            soc_lost: p.soc_lost,
            date: p.date,
    ...
    pingTableTabulator = new TabulatorFull$1("#pingTable", {
        ...
        columns: [
            ...
            { title: "Last Mapped Type", field: "last_mapped_type", visible: false },
            { title: "Brand", field: "brand", headerFilter: true, visible: true },
