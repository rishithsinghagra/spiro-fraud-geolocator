...
class VirtualDomVertical extends Renderer{
	constructor(table){
		...
		this.vDomRowHeight = 0; //approximation of row heights for padding
		...
		this.vDomMaxRenderChain = 1000; //the maximum number of dom elements that can be rendered in 1 go

		this.vDomWindowBuffer = 1000; //window row buffer before removing elements, to smooth scrolling

		this.vDomWindowMinTotalRows = 1000; //minimum number of rows to be generated in virtual dom (prevent buffering issues on tables with tall rows)
